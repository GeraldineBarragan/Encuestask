          ...
          <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                ...
                <a href="#" class="btn btn-primary btn-block mt-3">Ver todas</a>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="card border-left-success shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      ...
                      <div class="col-auto">
                        <i
                          class="fas fa-question-circle fa-2x text-gray-300"></i>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="list-group">
                  <a href="#" class="list-group-item list-group-item-action">
                    <div class="d-flex w-100 justify-content-between">
                      ...
                      <span class="badge badge-primary badge-pill">12 usuarios</span>
                    </div>
                    <p class="mb-1">
                  ...
                  <a href="#" class="list-group-item list-group-item-action">
                    <div class="d-flex w-100 justify-content-between">
                      ...
                      <span class="badge badge-primary badge-pill">25 usuarios</span>
                    </div>
                    <p class="mb-1">
                  ...
                  <a href="#" class="list-group-item list-group-item-action">
                    <div class="d-flex w-100 justify-content-between">
                      ...
                      <span class="badge badge-primary badge-pill">1,208 usuarios</span>
                    </div>
                    <p class="mb-1">
