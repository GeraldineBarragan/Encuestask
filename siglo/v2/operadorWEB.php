...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$sql = "SELECT id, registro, nome, ativo, clave, sesion_activa FROM operadores WHERE registro = '" . $operador . "'";
			...
			if ($row["ativo"] == 1) {
				...
				{		
					...
					{		
						...
						$sql = "UPDATE operadores SET sesion_activa = 1 WHERE id=$id";
						$result = $conn->query($sql);
						if($row["sesion_activa"] == 1){
							$_SESSION['resultado'] = "SESION YA INICIADA";
...
else
{
	...
	header('Location: ../../../api/onyxweb/login.php');
}
